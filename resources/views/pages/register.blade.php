...
<head>
    ...
    <title>Register Mahasiswa - TSU</title>
           ...
           <form method="POST" action="{{ route('register.store') }}">
            ...
            <input type="hidden" name="role" id="role" value="mahasiswa">
                ...
                <div class="text-right">
                    <a href="{{ route('login') }}" class="text-tsu-blue-link text-sm hover:underline font-medium">
...
function setRole(role) {
    ...
    if (role === 'mahasiswa') {
        btnMahasiswa.classList.add('bg-tsu-teal', 'text-white');
        btnMahasiswa.classList.remove('bg-white', 'text-black');

        btnDosen.classList.add('bg-white', 'text-black');
        btnDosen.classList.remove('bg-tsu-teal', 'text-white');
    } else {
        btnDosen.classList.add('bg-tsu-teal', 'text-white');
        btnDosen.classList.remove('bg-white', 'text-black');

        btnMahasiswa.classList.add('bg-white', 'text-black');
        btnMahasiswa.classList.remove('bg-tsu-teal', 'text-white');
    }
}
</script>
